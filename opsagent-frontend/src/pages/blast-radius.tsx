    ...
    <div className="min-h-screen">
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          <Card>
            <p className="text-[10px] text-text-muted uppercase tracking-wider mb-1">Root Cause</p>
            <p className="text-sm font-bold text-critical font-mono">payment-service</p>
            <p className="text-xs text-text-dim mt-1">Connection pool exhausted, downstream timeouts</p>
          </Card>
          <Card>
