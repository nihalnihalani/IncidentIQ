          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                ...
                When orders-service went down at 3 AM, the incident document was percolated against all stored rules -- <strong className="text-agent-amber">3 rules matched instantly</strong>, triggering Slack, Jira, and auto-remediation.
              </p>
